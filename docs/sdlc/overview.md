...
| 구현 | implementation.md | draft | 2026-08-11 | S1 완료 (W-01·W-02·W-05) — 3/20. 다음 W-03 |
| 테스트 | — | — | — | 미착수 |
| 배포 | — | — | — | 미착수 |
...
- `design.md` 승인 완료 (2026-08-11). 구현 S1 완료, 다음은 W-03 (placeholder 계약)
- **중간 상태**: 새 템플릿은 들어갔지만 `sync-releases.mjs` 는 아직 옛 placeholder를 채운다 → W-03에서 해소 (push 전이라 실사용 영향 없음)
- `design.md` §5-1 placeholder 표에 `{{INTRO_TODO}}` 반영 필요 (설계 대비 변경 1건)
- 커밋 3건 완료(`0e091d0`·`5d1ed79`·`60e6c0f`)이나 **origin/main 에 push 하지 않았다** — 배포 영향 때문에 보류 중
