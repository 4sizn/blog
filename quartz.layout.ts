  ...
  beforeBody: [
    ...
    Component.ConditionalRender({
      component: Component.AboutHero({
        ...
        paragraphs: [
          "AI를 개발 프로세스에 적극적으로 활용하여 요구사항 분석, 기능 설계, 코드 작성 및 리팩터링, 테스트와 문서화 등 웹 개발 전반의 생산성을 높이는 방식에 관심을 가지고 실제 프로젝트에 적용하고 있습니다. 단순한 코드 생성을 넘어 AI와 기존 개발 도구를 결합하여 빠르게 아이디어를 검증하고, 서비스에 적합한 구조와 구현 방식을 찾아가는 개발을 지향합니다.",
          "새로운 기술과 개발 방식에 유연하게 접근하며, 좋은 동료들과 적극적으로 의견을 나누고 함께 더 나은 서비스를 만들어가는 개발자가 되고 싶습니다.",
        ],
